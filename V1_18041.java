...
public void placeOrder() {
    ...
    while (true) {
        ...
        while (true) {
            System.out.print("Do you want to order more ice creams? (yes/y or no/n): ");
            String moreOrder = sc.next().toLowerCase();
            if (moreOrder.equals("yes") || moreOrder.equals("y")) {
                break; 
            } else if (moreOrder.equals("no") || moreOrder.equals("n")) {
                generateBill();
                return; 
            } else {
                System.out.println("Invalid input. Please enter either 'yes', 'y', 'no', or 'n'.");
            }
        }
    }
}
